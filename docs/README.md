...
|----------------| --------------------|
| - Que sea usable. - Que tenga un login(Simulado). - Usar HTML,CSS JS vanilla. - No Angular, react, etc. - Subirlo a github con readme. - No clones de netflix,amazon, etc. - tomar en cuenta tamanos diferentes.               | Lenguajes de programación: HTML, CSS Bootstrap, JavaScript vanilla.
...
Abre el archivo de index.html y asegurate que las carpetas y todos los archivos se hayan descargado correctamente.
## Mockup
...
|--------|------------------|---------------------|---------------------|
|Sprint 1|La estructura de carpetas, login y seguimiento del Mockup. | Organizacion del Css, gestion del tiempo, ajustar un poco el tamano de mis imagenes | Tener mas claro que dudas puedo tener para preguntarle al challenger.|
